// OrderContexxt class manages the current state of the order
class OrderContext {
    private OrderState currentState;

    // Constructor initialize the state to ORDER_PLACED
    public OrderContext() {
    ...
    // Nethod to get the current state of the order
    public String getCurrentState() {
        return currentState.getStateName();
    }
}

// OrderState interface defines the behaviour of the order states
...
public class FoodDeliveryWithState {
