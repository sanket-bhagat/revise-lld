...
class CheckoutService {
    ...
    public CheckoutService(RegionFactory factory, String getewayType) {
        this.gatewayType = getewayType;
        this.PaymentGateway = factory.createPaymentGateway(getewayType);
...
public class CheckoutServiceWithAbstractFactory {
